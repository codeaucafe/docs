...
dolt_gc`](../version-control/dolt-sql-functions.md#dolt_gc) through any connected client.

NOTE: Performing GC on [a cluster replica](../server/replication.md) which is in standby mode is not
