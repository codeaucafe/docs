...
| `SELECT DOLT_CLONE('post-no-preference/options');` | [Clones the `post-no-preference/options` database from DoltHub](../reference/sql/version-control/dolt-sql-functions.md#dolt_clone) |

## Stage and snapshot

| SQL                                      | Comments                                                                                                            |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `SELECT DOLT_ADD('myTable');`            | [Adds a table to the staging area](../reference/sql/version-control/dolt-sql-functions.md#dolt_add)                |
| `SELECT DOLT_RESET();`                   | [Removes staged tables, keeps working changes](../reference/sql/version-control/dolt-sql-functions.md#dolt_reset)  |
| `SELECT DOLT_RESET('--hard');`           | [Resets all staged and working changes to HEAD](../reference/sql/version-control/dolt-sql-functions.md#dolt_reset) |
| `SELECT DOLT_COMMIT('-m', 'a commit');`  | [Commits staged tables as a new snapshot](../reference/sql/version-control/dolt-sql-functions.md#dolt_commit)      |
| `SELECT DOLT_COMMIT('-Am', 'a commit');` | [Stages and commits all tables](../reference/sql/version-control/dolt-sql-functions.md#dolt_commit)                |
...
| `SELECT DOLT_BRANCH('myBranch');`         | [Creates a new branch](../reference/sql/version-control/dolt-sql-functions.md#dolt_branch)                       |
| `SELECT DOLT_CHECKOUT('myBranch');`       | [Switches to another branch](../reference/sql/version-control/dolt-sql-functions.md#dolt_checkout)               |
| `SELECT DOLT_CHECKOUT('-b', 'myBranch');` | [Creates a new branch and switches to it](../reference/sql/version-control/dolt-sql-functions.md#dolt_checkout)  |
| `SELECT DOLT_MERGE('myBranch');`          | [Merges a branch into the checked out branch](../reference/sql/version-control/dolt-sql-functions.md#dolt_merge) |
...
| SQL                                                      | Comments                                                                                                                        |
| -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `SELECT DOLT_REMOTE('add', 'myRemote', 'myOrg/myRepo');` | [Adds a new DoltHub remote](../reference/sql/version-control/dolt-sql-functions.md#dolt_remote)                                |
| `SELECT * FROM dolt_remotes;`                            | [Lists remotes](../reference/sql/version-control/dolt-system-tables.md#dolt_remotes)                                            |
| `SELECT DOLT_FETCH();`                                   | [Fetches all branches from the remote](../reference/sql/version-control/dolt-sql-functions.md#dolt_fetch)                      |
| `SELECT DOLT_PULL();`                                    | [Fetch and merge commits from the remote tracking branch](../reference/sql/version-control/dolt-sql-functions.md#dolt_pull)    |
| `SELECT DOLT_PUSH('origin', 'myBranch');`                | [Push local commits of branch `myBranch` to remote `origin`](../reference/sql/version-control/dolt-sql-functions.md#dolt_push) |
| `SELECT DOLT_PUSH();`                                    | [Push local commits to the remote tracking branch](../reference/sql/version-control/dolt-sql-functions.md#dolt_push)           |
...
| `SELECT DOLT_REVERT('gtfv1qhr5le61njimcbses9oom0de41e');`                 | [Creates a new commit which reverts the changes in a prior commit](../reference/sql/version-control/dolt-sql-functions.md#dolt_revert)                   |
...
| `SELECT DOLT_CONFLICTS_RESOLVE('--theirs', 'mytable');`                   | [Resolves conflicts in `mytable` by taking their changes](../reference/sql/version-control/dolt-sql-functions.md#dolt_conflicts_resolve)                 |
| `SELECT DOLT_TAG('tag1', 'myBranch');`                                    | [Creates a new tag at the HEAD of `mybranch`](../reference/sql/version-control/dolt-sql-functions.md#dolt_tag)                                           |
| `SELECT DOLT_CHERRY_PICK('qj6ouhjvtrnp1rgbvajaohmthoru2772');`            | [Applies the changes in a commit to the current branch HEAD](../reference/sql/version-control/dolt-sql-functions.md#dolt_cherry_pick)                    |
...
| `SELECT DOLT_VERIFY_CONSTRAINTS();`                                       | [Checks for constraint violations (e.g. after checks had been disabled)](../reference/sql/version-control/dolt-sql-functions.md#dolt_verify_constraints) |
| `SELECT DOLT_GC();`                                                       | [Runs garbage collection to compact the size of the database on disk](../reference/sql/version-control/dolt-sql-functions.md#dolt_gc)                    |
| `SELECT DOLT_REBASE('--interactive', 'main');`                            | [Begins an interactive rebase session](../reference/sql/version-control/dolt-sql-functions.md#dolt_rebase)                                               |
