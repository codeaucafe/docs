...
The Dolt version is `1.43.16`.

<!-- START___DOLT___LATENCY_RESULTS_TABLE -->
|       Read Tests        | MySQL |  Dolt  | Multiple |
|-------------------------|-------|--------|----------|
| covering\_index\_scan   |  2.14 |   0.62 |      0.3 |
...
| oltp\_read\_only        |  3.49 |   5.57 |      1.6 |
| select\_random\_points  |  0.34 |   0.67 |      2.0 |
| select\_random\_ranges  |  0.39 |   0.67 |      1.7 |
...
| oltp\_write\_only        |  5.28 |  5.88 |      1.1 |
| types\_delete\_insert    |   7.7 |  6.21 |      0.8 |
