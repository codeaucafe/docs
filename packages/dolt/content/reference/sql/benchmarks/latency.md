...
The Dolt version is `1.49.3`.

<!-- START___DOLT___LATENCY_RESULTS_TABLE -->
|       Read Tests        | MySQL |  Dolt  | Multiple |
|-------------------------|-------|--------|----------|
| covering\_index\_scan   |  1.89 |   0.63 |     0.33 |
| groupby\_scan           | 13.22 |  18.28 |     1.38 |
...
| oltp\_read\_write        |   8.9 | 11.65 |     1.31 |
