...
- [Java mariadb-java-client test code](https://github.com/dolthub/dolt/blob/main/integration-tests/mysql-client-tests/java/MariaDBConnectorTest.java)

### r2dbc-mariadb

- [Official Client Documentation](https://mariadb.com/docs/connectors/mariadb-connector-r2dbc/mariadb-connector-r2dbc-guide)
- [Java r2dbc-mariadb test code](https://github.com/dolthub/dolt/blob/main/integration-tests/mysql-client-tests/java/R2DBCMariaDBTest.java)
...
- [C libmysqlclient test code](https://github.com/dolthub/dolt/blob/main/integration-tests/mysql-client-tests/c/mysql-client-test.c)

### MariaDB Connector/C

- [Official Client Documentation](https://mariadb.com/kb/en/mariadb-connector-c/)
- [C MariaDB Connector/C test code](https://github.com/dolthub/dolt/blob/main/integration-tests/mysql-client-tests/c/mariadb-client-test.c)
...
We support `mysql-connector-cpp` and `mariadb-connector-cpp`. We build with the connnectors through the available OS packages.
...
- [go-mysql test code](https://github.com/dolthub/dolt/blob/main/integration-tests/mysql-client-tests/go-mysql/main.go)
